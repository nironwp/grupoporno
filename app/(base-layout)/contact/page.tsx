    ...
    <form action="https://api.web3forms.com/submit" onSubmit={(e) => {
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <div className="relative z-0 col-span-2">
          ...
          }} name="message" rows="5" class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" "></textarea>
